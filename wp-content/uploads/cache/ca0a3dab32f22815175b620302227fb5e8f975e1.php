    ...
    <div class="container">
            ...
            <div
                ...
                <div class="lg:w-full relative">
                    <a id="header-logo" class="navbar-brand header-logo py-5 inline-block align-middle"
                        ...
                        <img src="<?php echo $data->module['logoheader']->url; ?>" alt="<?php echo $data->module['logoheader']->alt; ?>" class="w-full">
                    </a>
                </div>
        ...
        lg:flex-row lg:justify-end">
                    <li class="menu-item mb-0 ">
                        <a class="block py-9 lg:p-9 no-underline text-black" href="<?php echo $data->module['linkhome']->url; ?>">TRANG CHỦ</a>
                    </li>
                    <li class="menu-item mb-0">
                        <a class="block py-9 lg:p-9 no-underline text-black" href="#">GIỚI THIỆU</a>
;                    </li>
                    <li class="menu-item mb-0">
                        <a class="block py-9 lg:p-9 no-underline text-black" href="<?php echo $data->module['linkproject']->url; ?>">DỰ ÁN</a>
                    </li>
